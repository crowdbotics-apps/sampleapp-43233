"""
Django settings for sampleapp_43233 project.
...
ROOT_URLCONF = 'sampleapp_43233.urls'
...
WSGI_APPLICATION = 'sampleapp_43233.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sampleapp_43233 API",
    "DESCRIPTION": "API documentation for sampleapp_43233 App",
    "VERSION": "v1",
}
